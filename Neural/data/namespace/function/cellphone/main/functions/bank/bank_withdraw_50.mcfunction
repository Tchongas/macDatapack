...
execute if score @s digit1 matches 50.. run give @s disc_fragment_5[custom_name='{"italic":false,"color":"yellow","text":"Dollar"}',hide_additional_tooltip={},minecraft:custom_model_data={strings:["2"]}] 50
